<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:74:"D:\wamp\www\thinkphp5.0.7\public/../application/home\view\index\index.html";i:1502424046;s:75:"D:\wamp\www\thinkphp5.0.7\public/../application/home\view\Public\block.html";i:1502423751;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <!-- Main CSS file -->
    <link rel="stylesheet" href="__PUBLICINDEX__css/bootstrap.min.css" />
    <link rel="stylesheet" href="__PUBLICINDEX__css/owl.carousel.css" />
    <link rel="stylesheet" href="__PUBLICINDEX__css/magnific-popup.css" />
    <link rel="stylesheet" href="__PUBLICINDEX__css/font-awesome.css" />
    <link rel="stylesheet" href="__PUBLICINDEX__css/style.css" />
    <link rel="stylesheet" href="__PUBLICINDEX__css/responsive.css" />


    <!-- Favicon -->
    <link rel="shortcut icon" href="__PUBLICINDEX__images/icon/favicon.png">
    <link rel="apple-touch-icon-precomposed" sizes="144x144" href="__PUBLICINDEX__images/icon/apple-touch-icon-144-precomposed.png">
    <link rel="apple-touch-icon-precomposed" sizes="114x114" href="__PUBLICINDEX__images/icon/apple-touch-icon-114-precomposed.png">
    <link rel="apple-touch-icon-precomposed" sizes="72x72" href="__PUBLICINDEX__images/icon/apple-touch-icon-72-precomposed.png">
    <link rel="apple-touch-icon-precomposed" href="__PUBLICINDEX__images/icon/apple-touch-icon-57-precomposed.png">
		...
		<nav class="navbar st-navbar navbar-fixed-top">
			<div class="container">
				<div class="navbar-header">
					...
					<a class="logo" href="index.html"><img src="__PUBLICINDEX__images/logo.png" alt=""></a>
				</div>
	...
	<section id="slider">
		<div id="home-carousel" class="carousel slide" data-ride="carousel">
			<div class="carousel-inner">
				<div class="item active" style="background-image: url(__PUBLICINDEX__images/slider/01.jpg)">
				...
				<div class="item" style="background-image: url(__PUBLICINDEX__images/slider/02.jpg)">
					<div class="carousel-caption container">
						<div class="row">
							<div class="col-sm-7">
								<h1>You are entire </h1>
				...
				<div class="item" style="background-image: url(__PUBLICINDEX__images/slider/03.jpg)">
					<div class="carousel-caption container">
						<div class="row">
							<div class="col-sm-7">
								<h1>You are entire </h1>
				...
				<div class="item" style="background-image: url(__PUBLICINDEX__images/slider/04.jpg)">
					<div class="carousel-caption container">
						<div class="row">
							<div class="col-sm-7">
								<h1>You are entire </h1>
...
<!-- JS -->
<script type="text/javascript" src="__PUBLICINDEX__js/jquery.min.js"></script><!-- jQuery -->
<script type="text/javascript" src="__PUBLICINDEX__js/bootstrap.min.js"></script><!-- Bootstrap -->
<script type="text/javascript" src="__PUBLICINDEX__js/jquery.parallax.js"></script><!-- Parallax -->
<script type="text/javascript" src="__PUBLICINDEX__js/smoothscroll.js"></script><!-- Smooth Scroll -->
<script type="text/javascript" src="__PUBLICINDEX__js/masonry.pkgd.min.js"></script><!-- masonry -->
<script type="text/javascript" src="__PUBLICINDEX__js/jquery.fitvids.js"></script><!-- fitvids -->
<script type="text/javascript" src="__PUBLICINDEX__js/owl.carousel.min.js"></script><!-- Owl-Carousel -->
<script type="text/javascript" src="__PUBLICINDEX__js/jquery.counterup.min.js"></script><!-- CounterUp -->
<script type="text/javascript" src="__PUBLICINDEX__js/waypoints.min.js"></script><!-- CounterUp -->
<script type="text/javascript" src="__PUBLICINDEX__js/jquery.isotope.min.js"></script><!-- isotope -->
<script type="text/javascript" src="__PUBLICINDEX__js/jquery.magnific-popup.min.js"></script><!-- magnific-popup -->
<script type="text/javascript" src="__PUBLICINDEX__js/scripts.js"></script><!-- Scripts -->
